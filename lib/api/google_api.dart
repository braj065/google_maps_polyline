...
final String _appleBundleId = "google_maps_polyline.flutterbase.com";
final String _googleMapsApiKey = "_google_maps_polyline_API_KEY_";
final _googleApiHeaders = {"x-ios-bundle-identifier": _appleBundleId};

//Platform.environment['API_KEY']

final prodApiProxy =
    "https://europe-west2-flutterbasedotcom.cloudfunctions.net/google_maps_polylineWebDemo";
